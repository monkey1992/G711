...
G711DECODE_API int g711a_Encode(unsigned char *src, unsigned char *dest,
...
G711DECODE_API int g711a_Decode(unsigned char *src, unsigned char *dest,
		unsigned int srclen, unsigned int *dstlen) {
	int i;
...
G711DECODE_API int g711u_Encode(unsigned char *src, unsigned char *dest,
		unsigned int srclen, unsigned int *dstlen) {
	int i, tmp;
	signed short src_data;
	unsigned char mask;
...
G711DECODE_API int g711u_Decode(unsigned char *src, unsigned char *dest,
		unsigned int srclen, unsigned int *dstlen) {
	int i;
	unsigned short *pd = (unsigned short*) dest;
	for (i = 0; i < srclen; i++) {
